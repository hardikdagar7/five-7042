...
.. important::
   ...
   **not be valid if your [five-7042] container is NOT running**.

.. tip::
   You must have your [five-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40821  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hardikdagar0207/five-7042-amd64 (https://hub.docker.com/r/hardikdagar0207/five-7042-amd64)
...
.. code-block::
   ...
   docker run -d -p 37863:37863 -p 53063:53063 -p 60827:60827 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=five-7042 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-five-7042 \
          --env GITUSERNAME=hardikdagar7 \
          --env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=37863 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=53063  \
          --env SOLUTIONVIPERVIZPORT=60827 \
          ...
          hardikdagar0207/five-7042-amd64
...
[five-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/five-7042
...
.. important::
   https://five-7042.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-five-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37863, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39143, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43779, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36301, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36371, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40701, HPDEHOST=127.0.1.1, HPDEPORT=33593, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39295

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1779-five-7042,solution_preprocessing_ai_mqtt_dag-five-7042, python-preprocess-5339-five-7042,solution_preprocessing_ai_mqtt_dag-five-7042, python-ai-4656-five-7042,solution_preprocessing_ai_mqtt_dag-five-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
